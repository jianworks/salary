...
import com.csjian.report.xls.P01Reporter;
 ...
 *
 */
public class P01XlsServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public P01XlsServlet() {
	  super();
  }   	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			response.setHeader("Content-Disposition","attachment;filename=\"monthlysalary.xls" +"\""); 
