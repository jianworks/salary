...
import com.csjian.report.pdf.P03Reporter;
 ...
 *
 */
public class P03Servlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
    /* (non-Java-doc)
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  try {
  	  ...
  	  response.setHeader("Content-Disposition","attachment;filename=\"banktransfer.pdf" +"\""); 
  	  ...
  	  P03Reporter.generatePDF(regcode, year, month, company, salaryDigest, os);
      os.flush();
      os.close();
	  } catch (Exception e) {
