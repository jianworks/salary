...
import com.csjian.report.pdf.P02Reporter;
 ...
 *
 */
public class P02Servlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
    /* (non-Java-doc)
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  try {
  	  ...
  	  response.setHeader("Content-Disposition","attachment;filename=\"salaryreceipe.pdf" +"\""); 
  	  ...
  	  ServletContext servletContext = request.getSession().getServletContext();
  		...
  		SalaryBean[] salaryList = sdao.getAllSalaries(regcode, year, month);
  		daoFactory.returnDao(DaoFactory.SALARY, sdao);

  	  
  	  P02Reporter.generatePDF(regcode, year, month, company, salaryList, os);
      os.flush();
      os.close();
	  } catch (Exception e) {
