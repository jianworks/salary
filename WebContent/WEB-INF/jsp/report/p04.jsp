...
%>
  ...
  <!--
    ...
    function doPDF() {
      with (document.mainform) {
        location.href = "servlet/P04Servlet?regcode=<%=company.getRegcode()%>&year=" + year.value + "&month=" + month.value;
      }
    }
   //-->
  </SCRIPT>

  <form method="POST" Name="mainform" Action="<%=response.encodeURL("report.do?action=p04") %>" class = "entry-form" onSubmit='return validate();'>
  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
    <tr><td colspan=7>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
          <tr>
            <td height="30" class=moduleTitle valign="bottom">薪資印領清冊</td>
          </tr>
          <TR><TD>
      ...
      <td colspan="7" class="background_left_menu"><div align="left">
        <table width="95%"  border="1" cellpadding="0" cellspacing="0">
          <tr class=moduleListTitle height="25">
            <td colspan=4><div align="center"><%=company.getRegname() + "  " + (Integer.parseInt(year)-1911) + "年" +  month + "月 薪資印領清冊"%></div></td>
          </tr>
          <tr class=moduleListTitle height="25">
            <td><div align="center">序號</div></td>
            <td><div align="center">姓名</div></td>
            <td><div align="center">實發金額</div></td>
            <td><div align="center">簽領</div></td>
          </tr>
          <% 
          	int total = 0;
